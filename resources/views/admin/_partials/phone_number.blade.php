                                                ...
                                                <div class="input-group" data-input-flag="">
                                                    <button class="btn btn-light border" type="button"
                                                        data-bs-toggle="dropdown" aria-expanded="false"><img
                                                            src="{{ asset('assets/images/flags/ng.svg') }}" alt="flag img"
                                                            height="20" class="country-flagimg rounded"><span
                                                            class="ms-2 country-codeno">+ 234</span></button>
                                                    ...
                                                    <div class="dropdown-menu w-100">
                                                        ...
                                                        <ul class="list-unstyled dropdown-menu-list mb-0">
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/dz.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Algeria</div>
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+213</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ao.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Angola</div><span
                                                                            class="countrylist-codeno text-muted">+244</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/bj.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Benin</div><span
                                                                            class="countrylist-codeno text-muted">+229</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/bw.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+267</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/bf.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Burkina Faso
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+226</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/bi.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+257</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/cm.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+237</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/cv.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Cape Verde</div>
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+238</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/km.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+269</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/cg.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Congo</div><span
                                                                            class="countrylist-codeno text-muted">+242</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ci.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Côte d'Ivoire
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+225</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/dj.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+253</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/eg.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Egypt</div><span
                                                                            class="countrylist-codeno text-muted">+20</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/gq.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Equatorial
                                                                            Guinea</div><span
                                                                            class="countrylist-codeno text-muted">+240</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/er.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+291</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/et.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+251</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ga.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Gabon</div><span
                                                                            class="countrylist-codeno text-muted">+241</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/gm.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+220</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/gh.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Ghana</div><span
                                                                            class="countrylist-codeno text-muted">+233</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/gn.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+224</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/gw.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Guinea-Bissau
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+245</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ke.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Kenya</div><span
                                                                            class="countrylist-codeno text-muted">+254</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ls.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+266</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/lr.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+231</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ly.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Libya</div><span
                                                                            class="countrylist-codeno text-muted">+218</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/mg.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+261</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/mw.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+265</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ml.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Mali</div><span
                                                                            class="countrylist-codeno text-muted">+223</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/mr.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+222</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/mu.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+230</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/yt.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Mayotte</div>
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+262</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ma.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+212</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/mz.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+258</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/na.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+264</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ne.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Niger</div><span
                                                                            class="countrylist-codeno text-muted">+227</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ng.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+234</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/rw.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+250</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/re.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Réunion</div>
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+262</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sh.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Saint Helena
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+290</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sn.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+221</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sc.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+248</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sl.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Sierra Leone
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+232</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/so.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+252</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/za.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">South Africa
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+27</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ss.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">South Sudan
                                                                        </div><span
                                                                            class="countrylist-codeno text-muted">+211</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sd.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Sudan</div><span
                                                                            class="countrylist-codeno text-muted">+249</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/sz.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+268</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/tz.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+255</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/tg.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        <div class="country-name me-1">Togo</div><span
                                                                            class="countrylist-codeno text-muted">+228</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/tn.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+216</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/ug.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+256</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/zm.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+260</span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="dropdown-item d-flex">
                                                                <div class="flex-shrink-0 me-2"><img
                                                                        src="{{ asset('assets/images/flags/zw.svg') }}"
                                                                        alt="country flag" class="options-flagimg"
                                                                        height="20"></div>
                                                                <div class="flex-grow-1">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <span
                                                                            class="countrylist-codeno text-muted">+263</span>
                                                                    </div>
                                                                </div>
                                                            </li>
