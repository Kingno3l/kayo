                    ...
                    <div class="card crm-widget">
                        <div class="card-body p-0">
                            <div class="row row-cols-xxl-2 row-cols-md-2 row-cols-1 g-0">
                                <div class="col">
                                    <div class="py-4 px-3">
                                        <h5 class="text-muted text-uppercase fs-13">Associate Member
                                            <i
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h2 class="mb-0">
                                                    <span class="counter-value"
                                                        data-target="{{ $associateMemberCount }}">{{ $associateMemberCount }}</span>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                        <h5 class="text-muted text-uppercase fs-13">Student Member
                                            <i
                                                class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i>
                                        </h5>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h2 class="mb-0">
                                                    <span class="counter-value"
                                                        data-target="{{ $studentMemberCount }}">{{ $studentMemberCount }}</span>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-4 px-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h2 class="mb-0">
                                                    <span class="counter-value"
                                                        data-target="{{ $totalRegisteredUsers }}">{{ $totalRegisteredUsers }}</span>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
