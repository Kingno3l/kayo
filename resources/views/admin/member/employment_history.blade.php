...
@section('user')
    ...
    <div class="card mt-xxl-n5">
        <div class="card-header">
            <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#employmentHistory" role="tab">
    ...
    @foreach ($employmentHistory as $index => $employment)
        <tr>
            ...
            <td class="text-center">{{ \Carbon\Carbon::parse($employment->start_date)->format('M d, Y') }}</td>
            <td class="text-center">{{ $employment->end_date ? \Carbon\Carbon::parse($employment->end_date)->format('M d, Y') : 'Present' }}</td>
            <td class="text-center">{{ $employment->responsibilities }}</td>
            <td class="text-center">{{ \Carbon\Carbon::parse($employment->created_at)->format('M d, Y') }}</td>
        </tr>
    @endforeach
</tbody>
