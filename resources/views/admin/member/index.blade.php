            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('member.profile', $member->id) }}" class="text-decoration-none">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('member.nextofkin.referee', $member->id) }}" class="text-decoration-none">
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <p class="fw-medium text-muted mb-0">{{ $member->name }}'s Next of
                                                        Kin
                                                        and Referee Information</p>
                                                    <h2 class="mt-4 ff-secondary fw-semibold"><span>View Next of Kin and
                                                            Referee Information</span></h2>
