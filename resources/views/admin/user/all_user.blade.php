...
@section('admin')
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th>S1</th>
                                                <th class="text-center sort" data-sort="customer_name">Customer</th>
                                                <th class="text-center sort" data-sort="email">Email</th>
                                                <th class="text-center sort" data-sort="phone">Phone</th>
                                                <th class="text-center sort" data-sort="date">Joining Date</th>
                                                <th class="text-center sort" data-sort="status">Online Status</th>
                                                <th class="text-center sort" data-sort="email">Registration Number</th>
                                                <th class="text-center sort" data-sort="status">Country</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($allUser as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center email">{{ $item->registration_number }}</td>
    ...
    <!-- HTML Button -->
    <button id="notify-button" class="btn btn-primary">Trigger Notification</button>
