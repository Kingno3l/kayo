                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="text-center sort" data-sort="date">Last Paid Date</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center date">
                                                        @if ($item->payments->isNotEmpty())
                                                           <span
                                                                class="badge bg-warning-subtle text-warning text-uppercase">  {{ $item->payments->last()->created_at->format('d M, Y') }} </span>
                                                        @else
                                                             <span
                                                                class="badge bg-danger-subtle text-danger text-uppercase">This user has never paid any
                                                                due</span>
                                                        @endif
                                                    </td>
