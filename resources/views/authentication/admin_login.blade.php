                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Creating a network of young insurance professionals for the purpose of exchanging information and ideas."</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Creating awareness of insurance to increase insurance penetration in Africa."</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" To demonstrate that insurance can be a rewarding and stimulating lifetime career.
 "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue YIPs.</p>
                                        </div>
...
<!--  themesbrand.com/velzon/html/creative/ -->
