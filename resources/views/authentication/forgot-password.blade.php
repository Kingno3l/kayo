...
<head>
    ...
    <meta charset="utf-8" />
    <title>Reset Password | YIPS Africa</title>
                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Reset password with YIPS Africa</p>
                                        ...
                                        <div class="p-2">
                                            <!-- Session Status -->
                                            <x-auth-session-status class="mb-4 input-success" :status="session('status')" />
                                            <form method="POST" action="{{ route('password.email') }}" x-data="formSubmit">
                                                @csrf
