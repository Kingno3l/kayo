...
<h5 class="text-primary">
    Welcome {{ Str::title($user->name) }}, 
    Continue Account Creation for {{ strtolower($user->email) }},
</h5>
<p class="text-muted">Get your YIPS account now</p>

                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST"
                                        action="{{ route('registration.complete', $user->email_verification_token) }}">
                                        @csrf

                                        <!-- Password Requirements Display -->
                                        <div id="password-requirements" class="p-3 bg-light mb-3 rounded">
                                            <h5 class="fs-13 fw-semibold">Password must contain:</h5>
                                            <p id="pass-length" class="fs-12 mb-2 text-danger">- At least 8 characters
                                            </p>
                                            <p id="pass-lower" class="fs-12 mb-2 text-danger">- At least one lowercase
                                                letter (a-z)</p>
                                            <p id="pass-upper" class="fs-12 mb-2 text-danger">- At least one uppercase
                                                letter (A-Z)</p>
                                            <p id="pass-number" class="fs-12 mb-2 text-danger">- At least one number
                                                (0-9)</p>
                                            <p id="pass-match" class="fs-12 mb-0 text-danger">- Password and
                                                confirmation must match</p>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" name="password_confirmation"
                                                    id="password_confirmation" class="form-control pe-5 password-input"
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="terms-agreement">
                                                    I agree to the YIPS <a href="#"
                                                        class="text-primary text-decoration-underline fst-normal fw-medium">Terms
                                                        of Use</a> <span class="text-danger">*</span>
                                                </label>
                                                <div class="invalid-feedback">You must agree to the terms of use before
                                                    registering</div>
                                            </div>
                                        </div>

                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit" id="signup-button"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validatePassword() {
            ...
            const allValid = lengthCheck && lowerCheck && upperCheck && numberCheck && matchCheck && termsCheckbox.checked;
        ...
        termsCheckbox.addEventListener('change', validatePassword); // Add this line to check terms agreement
    });
</script>
