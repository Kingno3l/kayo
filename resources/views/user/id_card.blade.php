    ...
    <div class="container mt-5">
                ...
                <div class="card"
                        ...
                        <div class="profile-user position-relative d-inline-block pt-3">
                            <div class="circle-container position-relative mx-auto"
                                ...
                                <img src="{{ !empty($profileData->photo) ? url('uploads/user_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                    ...
                                    style="width: 150px; height: 150px; top: 10px; left: 10px;"
                    ...
                    <div class="px-4 text-center">
                        <div class="text-left d-inline-block text-white">
                            ...
                            <p class="font-weight-bold mb-1 px-5">Country:
                                &nbsp;<span>{{ $profileData->country }}</span></p>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            document.getElementById('dl-pdf').onclick = function() {
                ...
                var opt = {
                    margin: 1,
                    filename: 'yips-membership-id-card.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
...
<body>
    <div class="container mt-5">
        ...
        @else
            @php
                // Get age
                $age = \Carbon\Carbon::parse($profileData->date_of_birth)->age;

                // Check if user is a student member
                $isStudentMember = $profileData->graduation_year > date('Y');
                $memberStatus = 'Member'; // Default member status

                // Determine status
                if ($age >= 40) {
                    $memberStatus = 'Associate Member';
                } elseif ($isStudentMember) {
                    $memberStatus = 'Student Member';
                }
            @endphp
            ...
            <div class="d-flex justify-content-center align-items-center vh-100" id="id-card-id">
                <div class="card"
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="fs-16 mb-1 mt-2 text-white">{{ $profileData->name }}</h5>
                        <p class="text-light mb-2">{{ $memberStatus }}</p> <!-- Display status here -->
                    </div>
                    <div class="px-4 text-center">
                        <div class="text-left d-inline-block text-white">
                            <p class="font-weight-bold mb-1 px-5">Registration Number:
