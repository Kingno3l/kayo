                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        @if ($hasPaidDues)
                                            ...
                                            <div class="d-flex gap-3 mt-4">
                                                <a href="{{route('id-card.show')}}" class="btn btn-success">Download Now</a>
                                            </div>
                                        @else
                                    ...
                                    <div class="mt-2 pt-1">
                                        ...
                                        <p class="mt-2 mb-0 text-muted"><span
                                                    class="badge bg-success-subtle text-success mb-0 me-1"> <span>
                                                        <i class="ri-arrow-down-line align-middle"></i>     Your annual dues are up to date, continue to enjoy your membership benefits.
                                        ...
                                        @else
                                            <p class="mt-2 mb-0 text-muted"><span
                                                    ...
                                                    </span> <a href="{{route('pay')}}" class="btn btn-success">Pay!</a>
