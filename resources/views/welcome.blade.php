            ...
            <section class="section job-hero-section bg-light pb-0" id="hero">
                <div class="container">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6">
                            <div>
                                <h1 class="display-6 fw-bold text-capitalize mb-3 lh-base">YIPs Africa</h1>
                                <p class="lead text-muted fw-normal lh-base mb-4">Test with yips, Test with yips, Test with yips, Test with yips, Test with yips, Test with yips, Test with yips, Test with yips.</p>
                            ...
                            <div class="position-relative home-img text-center mt-5 mt-lg-0">
                                <div class="card p-3 rounded shadow-lg inquiry-box">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h5 class="fs-15 lh-base mb-0">Work Inquiry from yips</h5>
                                    </div>
                                </div>
            ...
            <section class="py-5 bg-primary position-relative">
                ...
                <div class="container">
                    <div class="row align-items-center gy-4">
                        <div class="col-sm">
                            <div>
                                <h4 class="text-white fw-semibold">Get New New Notification!</h4>
                                <p class="text-white text-opacity-75 mb-0">Subscribe & get all related new notification.</p>
                            </div>
                        </div>
                        <!-- end col -->
                        <div class="col-sm-auto">
                        ...
                        <div class="col-lg-7 ms-lg-auto">
                            <div class="row">
                                <div class="col-sm-4 mt-4">
                                    <h5 class="text-white mb-0">Yips</h5>
                                ...
                                <div class="col-sm-4 mt-4">
                                    <h5 class="text-white mb-0">We are</h5>
                                    <div class="text-muted mt-3">
                                        <ul class="list-unstyled ff-secondary footer-list">
                        ...
                        <div class="col-sm-6">
                            <div>
                                <p class="copy-rights mb-0">
                                    <script> document.write(new Date().getFullYear()) </script> © Yips - Africa
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
